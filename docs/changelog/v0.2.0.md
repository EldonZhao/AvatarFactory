# AvatarFactory v0.2.0 - Multi-LLM Support

This release adds support for multiple LLM providers.
...
A: Only if you switch providers. Check [configuration.md](../configuration.md) for pricing.
...
1. Read [configuration.md](../configuration.md) for full LLM provider documentation
